...
<div class="container">
    ...
    <div class="card no-accounts-card">
        ...
        <div class="card-body">
            <!-- Card Title -->
            <h1 class="card-title">
                <i class="fas fa-ban text-danger"></i> Нет зарегистрированных учетных записей
            </h1>
            <!-- End Of Card Title -->
            <hr>
            <!-- Card Text -->
            ...
            <!-- End Of Card Text -->
            <br>
            <button class="btn btn-primary btn-lg shadow" type="button" data-bs-toggle="offcanvas"
