                    ...
                    <div id="flush-${account.account_id}" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex">Имя аккаунта <span
                                        class="ms-auto"><b>${account.account_name}</b></span></li>
                                <li class="list-group-item d-flex">Номер аккаунта <span
                                        class="ms-auto"><b>${account.account_number}</b></span></li>
                                <li class="list-group-item d-flex">Тип аккаунта <span
                                        class="ms-auto"><b>${account.account_type}</b></span></li>
                                <li class="list-group-item d-flex">Счёт аккаунта <span
                                        class="ms-auto"><b>${account.balance}</b></span></li>
                                <li class="list-group-item d-flex">Время создания <span
                                        class="ms-auto"><b>${account.updated_at}</b></span></li>
                            </ul>
                            <!-- Account Details List -->
                        </div>
                    </div>
